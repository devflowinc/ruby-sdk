...
module TrieveRubyClient
  class SearchOverGroupsData
    ...
    def hash
      [filters, get_collisions, get_total_pages, group_size, highlight_delimiters, highlight_results, highlight_threshold, page, page_size, query, score_threshold, search_type, slim_chunks].hash
    end
