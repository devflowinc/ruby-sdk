...
module TrieveRubyClient
  class SearchWithinGroupData
    ...
    def hash
      [date_bias, filters, group_id, group_tracking_id, highlight_delimiters, highlight_results, page, page_size, query, quote_negated_words, score_threshold, search_type, slim_chunks, use_weights].hash
    end
