...
module TrieveRubyClient
  class SearchWithinGroupData
    ...
    def hash
      [filters, get_total_pages, group_id, group_tracking_id, highlight_delimiters, highlight_results, highlight_threshold, page, page_size, query, recency_bias, score_threshold, search_type, slim_chunks, tag_weights, use_weights].hash
    end
