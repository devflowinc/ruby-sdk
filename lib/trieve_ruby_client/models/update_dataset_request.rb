...
module TrieveRubyClient
  class UpdateDatasetRequest
    ...
    attr_accessor :client_configuration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TrieveRubyClient::UpdateDatasetRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TrieveRubyClient::UpdateDatasetRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'client_configuration')
        self.client_configuration = attributes[:'client_configuration']
      end
      ...
      if attributes.key?(:'new_tracking_id')
        self.new_tracking_id = attributes[:'new_tracking_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          new_tracking_id == o.new_tracking_id &&
    ...
    def hash
      [client_configuration, dataset_id, dataset_name, new_tracking_id, server_configuration, tracking_id].hash
    end
