...
module TrieveRubyClient
  class ChunkReqPayload
    ...
    def hash
      [boost_phrase, chunk_html, convert_html_to_text, distance_phrase, group_ids, group_tracking_ids, image_urls, link, location, metadata, num_value, split_avg, tag_set, time_stamp, tracking_id, upsert_by_tracking_id, weight].hash
    end
