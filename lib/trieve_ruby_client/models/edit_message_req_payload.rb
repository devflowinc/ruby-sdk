...
module TrieveRubyClient
  class EditMessageReqPayload
    ...
    def hash
      [completion_first, concat_user_messages_query, filters, frequency_penalty, highlight_citations, highlight_delimiters, max_tokens, message_sort_order, new_message_content, page_size, presence_penalty, score_threshold, search_query, search_type, stop_tokens, stream_response, system_prompt, temperature, topic_id].hash
    end
