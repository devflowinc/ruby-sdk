...
module TrieveRubyClient
  class ChunkFilter
    ...
    def self.attribute_map
      {
        :'jsonb_prefilter' => :'jsonb_prefilter',
        :'must' => :'must',
        :'must_not' => :'must_not',
        :'should' => :'should'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TrieveRubyClient::ChunkFilter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TrieveRubyClient::ChunkFilter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'jsonb_prefilter')
        self.jsonb_prefilter = attributes[:'jsonb_prefilter']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          jsonb_prefilter == o.jsonb_prefilter &&
          must == o.must &&
          must_not == o.must_not &&
          should == o.should
    end
    ...
    def hash
      [jsonb_prefilter, must, must_not, should].hash
    end
