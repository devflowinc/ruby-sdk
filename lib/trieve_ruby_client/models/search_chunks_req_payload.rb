...
module TrieveRubyClient
  class SearchChunksReqPayload
    ...
    def hash
      [content_only, filters, get_collisions, get_total_pages, highlight_delimiters, highlight_max_length, highlight_max_num, highlight_results, highlight_threshold, highlight_window, page, page_size, query, recency_bias, score_threshold, search_type, slim_chunks, tag_weights, use_weights].hash
    end
