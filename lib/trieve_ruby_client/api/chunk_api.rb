...
module TrieveRubyClient
  class ChunkApi
    ...
    # @param autocomplete_data [AutocompleteData] JSON request payload to semantically search for chunks (chunks)
    # @param [Hash] opts the optional parameters
    # @return [SearchChunkQueryResponseBody]
    def autocomplete(tr_dataset, autocomplete_data, opts = {})
      data, _status_code, _headers = autocomplete_with_http_info(tr_dataset, autocomplete_data, opts)
      data
    end
    ...
    def autocomplete_with_http_info(tr_dataset, autocomplete_data, opts = {})
      ...
      # verify the required parameter 'autocomplete_data' is set
      if @api_client.config.client_side_validation && autocomplete_data.nil?
        fail ArgumentError, "Missing the required parameter 'autocomplete_data' when calling ChunkApi.autocomplete"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(autocomplete_data)
