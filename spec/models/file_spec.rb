...
# Unit tests for TrieveRubyClient::File
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TrieveRubyClient::File do
  let(:instance) { TrieveRubyClient::File.new }

  describe 'test an instance of File' do
    it 'should create an instance of File' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TrieveRubyClient::File)
    end
  end
