...
# Unit tests for TrieveRubyClient::ChunkReqPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TrieveRubyClient::ChunkReqPayload do
  let(:instance) { TrieveRubyClient::ChunkReqPayload.new }

  describe 'test an instance of ChunkReqPayload' do
    it 'should create an instance of ChunkReqPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TrieveRubyClient::ChunkReqPayload)
    end
  end
