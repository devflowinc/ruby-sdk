...
# Unit tests for TrieveRubyClient::AutocompleteData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TrieveRubyClient::AutocompleteData do
  let(:instance) { TrieveRubyClient::AutocompleteData.new }

  describe 'test an instance of AutocompleteData' do
    it 'should create an instance of AutocompleteData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TrieveRubyClient::AutocompleteData)
    end
  end
