...
# Unit tests for OpenapiClient::ChunkMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ChunkMetadata do
  let(:instance) { OpenapiClient::ChunkMetadata.new }

  describe 'test an instance of ChunkMetadata' do
    it 'should create an instance of ChunkMetadata' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ChunkMetadata)
    end
  end
