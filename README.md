...
```shell
gem install ./trieve_ruby_client-0.8.5.gem
```

(for development, run `gem install --dev ./trieve_ruby_client-0.8.5.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'trieve_ruby_client', '~> 0.8.5'
...
## Documentation for Models
 ...
 - [TrieveRubyClient::AutocompleteData](docs/AutocompleteData.md)
